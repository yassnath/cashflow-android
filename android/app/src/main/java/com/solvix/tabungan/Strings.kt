...
fun stringsFor(language: AppLanguage): AppStrings {
  val id = mapOf(
    ...
    "edit" to "Edit",
    "delete" to "Hapus",
    "page_dashboard" to "Dashboard",
    "page_income" to "Pemasukkan",
    "page_expense" to "Pengeluaran",
    "page_dreams" to "Target",
    "page_history" to "History",
    "page_insights" to "Insights",
    "page_loans" to "Debt Tracker",
    "page_ai_chat" to "Konsultasi AI",
    "page_calculator" to "Kalkulator",
    "page_report" to "Laporan",
    "page_profile" to "Profile",
    "page_settings" to "Pengaturan",
    "page_themes" to "Tema",
    "dashboard_greeting" to "Halo",
    "dashboard_balance" to "Saldo Bersih",
    "dashboard_income_vs_expense" to "Pemasukkan vs Pengeluaran",
    "dashboard_monthly_trend" to "Tren Bulanan",
    "dashboard_top_expenses" to "Top Pengeluaran Bulan Ini",
    "dashboard_goal_progress" to "Progres Target",
    "dashboard_active_loans" to "Hutang Aktif",
    "dashboard_quick_actions" to "Aksi Cepat",
    "dashboard_see_all" to "Lihat Semua",
    "dashboard_no_data" to "Belum ada data",
    "dashboard_this_month" to "Bulan ini",
    "dashboard_net_positive" to "Kondisi keuanganmu sehat!",
    "dashboard_net_negative" to "Pengeluaran melebihi pemasukkan",
    "dashboard_no_loans" to "Tidak ada hutang aktif",
    "dashboard_no_goals" to "Belum ada target tabungan",
    "dashboard_income_short" to "Masuk",
    "dashboard_expense_short" to "Keluar",
    "dashboard_add_income" to "Tambah Masuk",
    "dashboard_add_expense" to "Tambah Keluar",
    "dashboard_loans_total" to "Total hutang aktif",
    "menu_history" to "Riwayat Transaksi",
    "menu_theme" to "Tema",
    "menu_insights" to "Insights",
    "menu_loans" to "Debt Tracker",
    "menu_ai_chat" to "Konsultasi AI",
    "menu_admin" to "Admin",
    ...
    "label_signin_identifier" to "Username / Email",
    ...
    "section_loans_title" to "Debt Loan Tracking",
    "section_loans_subtitle" to "Pantau hutang, cicilan, kartu kredit, dan paylater.",
    "section_insights_title" to "Insights",
    "section_insights_subtitle" to "Sinyal keuangan otomatis berbasis data transaksi, target, dan debt.",
    "section_ai_chat_title" to "Konsultasi with AI",
    "section_ai_chat_subtitle" to "Tanya strategi keuangan langsung ke AI.",
    ...
    "insights_filter_timeframe" to "Rentang Waktu",
    "insights_filter_category" to "Kategori",
    "insights_filter_severity" to "Severity",
    "insights_refresh" to "Refresh Insights",
    "insights_refreshing" to "Refreshing...",
    "insights_empty" to "Tidak ada insight untuk filter saat ini.",
    "insights_ai_title" to "Ringkasan AI",
    "insights_ai_chip" to "AI Enhanced",
    ...
    "settings_ai_insights" to "AI Insights",
    "settings_ai_insights_desc" to "Tambahkan penjelasan natural language dari ringkasan data agregat.",
    "settings_ai_private_mode" to "Private Mode (AI)",
    "settings_ai_private_mode_desc" to "Sembunyikan nominal persis saat kirim ringkasan ke AI.",
    "settings_delete_account" to "Hapus Akun",
    "settings_delete_account_desc" to "Akun dan semua data akan dihapus permanen.",
    ...
    "confirm_delete_account" to "Hapus akun ini permanen? Semua data tidak bisa dikembalikan.",
    ...
    "delete_account_action" to "Hapus Akun Permanen",
    "account_deleted" to "Akun berhasil dihapus permanen",
    "account_delete_failed" to "Gagal menghapus akun. Coba lagi.",
    ...
    "signup_email_invalid" to "Email tidak valid.",
    ...
    "admin_restricted" to "Dashboard admin dibatasi oleh policy keamanan database.",
    ...
    "loan_type" to "Jenis Pinjaman",
    "loan_title" to "Judul Pinjaman",
    "loan_principal" to "Total Pinjaman",
    "loan_paid" to "Sudah Dibayar",
    "loan_interest_rate" to "Bunga per Tahun (%)",
    "loan_monthly_payment" to "Cicilan Bulanan",
    "loan_due_date" to "Jatuh Tempo",
    "loan_note" to "Catatan",
    "loan_type_friend_debt" to "Hutang ke Teman",
    "loan_type_installment" to "Cicilan",
    "loan_type_credit_card" to "Tagihan Kartu Kredit",
    "loan_type_paylater" to "Paylater",
    "loan_type_other" to "Lainnya",
    "loan_remaining" to "Sisa Tagihan",
    "loan_interest_simulation" to "Simulasi Bunga",
    "loan_payoff_estimate" to "Estimasi Lunas",
    "loan_balance_after_year" to "Estimasi Sisa 1 Tahun",
    "loan_month_unit" to "bulan",
    "loan_paid_off" to "Lunas",
    "loan_no_estimate" to "Tidak bisa dihitung",
    "loan_missing" to "Lengkapi data debt tracker dulu (catatan boleh kosong).",
    "loan_added" to "Data debt tracker berhasil ditambahkan",
    "loan_updated" to "Data debt tracker berhasil diperbarui",
    "loan_deleted" to "Data debt tracker berhasil dihapus",
    "confirm_delete_loan" to "Hapus data debt tracker ini?",
    "ai_prompt_placeholder" to "Tulis pertanyaan keuanganmu di sini...",
    "ai_send" to "Kirim",
    "ai_clear" to "Clear Chat",
    "ai_typing" to "AI sedang mengetik...",
    "ai_disclaimer" to "AI bisa membantu strategi keuangan, tetapi keputusan akhir tetap di kamu.",
    "ai_not_configured" to "CEREBRAS_API_KEY belum diatur di local.properties.",
    "ai_request_failed" to "Permintaan AI gagal. Coba lagi.",
    "note_label" to "Note",
    "signin_missing" to "Masukkan username dan password.",
    "signin_failed" to "Username atau password salah.",
    "signin_failed_network" to "Login gagal. Cek koneksi internet lalu coba lagi.",
    "signin_failed_policy" to "Login username terblokir konfigurasi keamanan database. Pakai email untuk login atau jalankan SQL migration terbaru.",
    "signin_biometric_missing" to "Data login biometric tidak tersedia. Login manual dulu.",
    "signin_biometric_expired" to "Sesi biometric tidak valid. Login manual dulu.",
    "password_change_success" to "Password berhasil diperbarui.",
    "password_change_relogin" to "Password berhasil diubah. Silakan login ulang.",
    "password_change_failed" to "Gagal mengubah password. Coba lagi.",
    "password_validation_empty" to "Semua kolom password wajib diisi.",
    "password_validation_length" to "Password baru minimal 8 karakter.",
    "password_validation_uppercase" to "Password harus memiliki huruf besar.",
    "password_validation_lowercase" to "Password harus memiliki huruf kecil.",
    "password_validation_digit" to "Password harus memiliki angka.",
    "password_validation_mismatch" to "Konfirmasi password tidak cocok.",
    "password_validation_same_as_current" to "Password baru tidak boleh sama dengan password saat ini.",
    "password_validation_current_invalid" to "Password saat ini tidak valid.",
    "signin_locked" to "Terlalu banyak percobaan login. Coba lagi dalam {seconds} detik.",
  )
  ...
  val en = mapOf(
    ...
    "page_insights" to "Insights",
    "page_loans" to "Debt Tracker",
    "page_ai_chat" to "AI Chat",
    "page_calculator" to "Calculator",
    "page_report" to "Report",
    "page_profile" to "Profile",
    "page_settings" to "Settings",
    "page_themes" to "Themes",
    "dashboard_greeting" to "Hello",
    "dashboard_balance" to "Net Balance",
    "dashboard_income_vs_expense" to "Income vs Expense",
    "dashboard_monthly_trend" to "Monthly Trend",
    "dashboard_top_expenses" to "Top Expenses This Month",
    "dashboard_goal_progress" to "Goal Progress",
    "dashboard_active_loans" to "Active Loans",
    "dashboard_quick_actions" to "Quick Actions",
    "dashboard_see_all" to "See All",
    "dashboard_no_data" to "No data yet",
    "dashboard_this_month" to "This month",
    "dashboard_net_positive" to "Your finances are healthy!",
    "dashboard_net_negative" to "Expenses exceed income",
    "dashboard_no_loans" to "No active loans",
    "dashboard_no_goals" to "No savings goals yet",
    "dashboard_income_short" to "In",
    "dashboard_expense_short" to "Out",
    "dashboard_add_income" to "Add Income",
    "dashboard_add_expense" to "Add Expense",
    "dashboard_loans_total" to "Total active debt",
    "menu_history" to "History",
    "menu_theme" to "Themes",
    "menu_insights" to "Insights",
    "menu_loans" to "Debt Tracker",
    "menu_ai_chat" to "AI Chat",
    "menu_admin" to "Admin",
    ...
    "section_loans_title" to "Debt Loan Tracking",
    "section_loans_subtitle" to "Track personal debt, installments, credit card bills, and paylater.",
    "section_insights_title" to "Insights",
    "section_insights_subtitle" to "Automated financial signals from transactions, goals, and debt.",
    "section_ai_chat_title" to "Consult with AI",
    "section_ai_chat_subtitle" to "Ask AI for practical financial advice.",
    ...
    "insights_filter_timeframe" to "Timeframe",
    "insights_filter_category" to "Category",
    "insights_filter_severity" to "Severity",
    "insights_refresh" to "Refresh Insights",
    "insights_refreshing" to "Refreshing...",
    "insights_empty" to "No insights available for current filters.",
    "insights_ai_title" to "AI Narrative",
    "insights_ai_chip" to "AI Enhanced",
    ...
    "settings_ai_insights" to "AI Insights",
    "settings_ai_insights_desc" to "Add natural language explanations from aggregated data summary.",
    "settings_ai_private_mode" to "Private Mode (AI)",
    "settings_ai_private_mode_desc" to "Hide exact amounts before sending summary to AI.",
    "settings_delete_account" to "Delete Account",
    "settings_delete_account_desc" to "Your account and all data will be permanently deleted.",
    ...
    "confirm_delete_account" to "Delete this account permanently? All data cannot be recovered.",
    ...
    "delete_account_action" to "Delete Account Permanently",
    "account_deleted" to "Account deleted permanently",
    "account_delete_failed" to "Failed to delete account. Please try again.",
    "dream_deleted" to "Goal deleted",
    "signup_success" to "Account created",
    "signup_missing" to "Please complete the sign up form.",
    "signup_email_invalid" to "Invalid email format.",
    ...
    "admin_restricted" to "Admin dashboard is restricted by database security policies.",
    ...
    "loan_title" to "Loan Title",
    "loan_principal" to "Principal",
    "loan_paid" to "Already Paid",
    "loan_interest_rate" to "Annual Interest (%)",
    "loan_monthly_payment" to "Monthly Payment",
    "loan_due_date" to "Due Date",
    "loan_note" to "Note",
    "loan_type_friend_debt" to "Friend Debt",
    "loan_type_installment" to "Installment",
    "loan_type_credit_card" to "Credit Card Bill",
    "loan_type_paylater" to "Paylater",
    "loan_type_other" to "Other",
    "loan_remaining" to "Remaining Balance",
    "loan_interest_simulation" to "Interest Simulation",
    "loan_payoff_estimate" to "Payoff Estimate",
    "loan_balance_after_year" to "Balance After 1 Year",
    "loan_month_unit" to "months",
    "loan_paid_off" to "Paid off",
    "loan_no_estimate" to "Cannot estimate",
    "loan_missing" to "Please complete the debt tracker form (notes can be empty).",
    "loan_added" to "Debt tracker entry added",
    "loan_updated" to "Debt tracker entry updated",
    "loan_deleted" to "Debt tracker entry deleted",
    "confirm_delete_loan" to "Delete this debt tracker entry?",
    "ai_prompt_placeholder" to "Type your finance question here...",
    "ai_send" to "Send",
    "ai_clear" to "Clear Chat",
    "ai_typing" to "AI is typing...",
    "ai_disclaimer" to "AI can help with strategy, but final decisions are still yours.",
    "ai_not_configured" to "CEREBRAS_API_KEY is not set in local.properties.",
    "ai_request_failed" to "AI request failed. Please try again.",
    "note_label" to "Note",
    "signin_missing" to "Enter username and password.",
    "signin_failed" to "Incorrect username or password.",
    "signin_failed_network" to "Sign-in failed. Check your network and try again.",
    "signin_failed_policy" to "Username sign-in is blocked by database security configuration. Use email sign-in or run the latest SQL migration.",
    "signin_biometric_missing" to "Biometric sign-in data is missing. Please sign in manually first.",
    "signin_biometric_expired" to "Biometric session is no longer valid. Please sign in manually.",
    "password_change_success" to "Password updated successfully.",
    "password_change_relogin" to "Password updated. Please sign in again.",
    "password_change_failed" to "Failed to update password. Please try again.",
    "password_validation_empty" to "All password fields are required.",
    "password_validation_length" to "New password must be at least 8 characters.",
    "password_validation_uppercase" to "Password must include an uppercase letter.",
    "password_validation_lowercase" to "Password must include a lowercase letter.",
    "password_validation_digit" to "Password must include a number.",
    "password_validation_mismatch" to "Password confirmation does not match.",
    "password_validation_same_as_current" to "New password must be different from current password.",
    "password_validation_current_invalid" to "Current password is incorrect.",
    "signin_locked" to "Too many sign-in attempts. Try again in {seconds} seconds.",
  )
...
fun optionList(language: AppLanguage, list: OptionList): List<String> {
  return when (list) {
    OptionList.Countries -> if (language == AppLanguage.ID) {
      allCountries(Locale.Builder().setLanguage("id").setRegion("ID").build())
    } else {
...
private fun allCountries(locale: Locale): List<String> {
  return Locale.getISOCountries()
    .map { code -> Locale.Builder().setRegion(code).build().getDisplayCountry(locale) }
